        ...
        <section id="home" className="min-h-screen flex flex-col justify-center items-center  text-slate-900">
          <div className="w-full max-w-full flex flex-col md:flex-row items-center justify-center gap-4 px-4">
            ...
            <div className="flex-shrink-0 flex justify-center items-center w-full md:max-w-md mb-8 md:mb-0">
              <img src={profilePic} alt="Profile" className="rounded-full w-[320px] h-[320px] object-fit " />
            </div>
            {/* Right: Content */}
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-xl text-white md:text-2xl font-medium mb-6">Fervent <span className="text-orange-500">Full Stack Developer</span> with great enthusiasm to enrich web. Totally I have 9.5 years of IT industry experience and specifically in full stack development I gained 5 years of experience.</p>
              <a
                href="#projects"
          ...
          <div className="skills w-full flex items-center justify-center py-4 bg-transparent overflow-hidden mt-10">
            <div className="relative w-full max-w-[92rem] h-20 overflow-hidden">
