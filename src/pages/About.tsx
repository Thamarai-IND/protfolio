...
const About: React.FC = () => (
  <section id="about" className="w-full bg-white py-20 flex flex-col items-center">
    <div className="w-full max-w-7xl">
      ...
      <div className="flex flex-col md:flex-row gap-10 items-stretch justify-center">
        {/* Left: Objective */}
        <div className="flex-1 bg-gray-900 rounded-xl shadow p-6 flex flex-col justify-center">
          <h3 className="text-2xl font-bold text-rose-600 mb-4 text-center md:text-left">OBJECTIVE</h3>
          <p className="text-lg text-teal-100 text-center md:text-left">
        ...
        {/* Right: Education */}
        <div className="flex-1 bg-gray-900 rounded-xl shadow p-6 flex flex-col justify-center">
          <h3 className="text-2xl font-bold text-rose-600 mb-4 text-center md:text-left">EDUCATION</h3>
          <div className="text-teal-100 text-center md:text-left">
            <div className="font-semibold text-lg mb-1">2010 - 2014</div>
