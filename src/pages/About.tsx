    ...
    <div className="w-full max-w-7xl">
      ...
      <div className="flex flex-col md:flex-row gap-10 items-stretch justify-center">
        ...
        <div className="flex-1 bg-gray-900 rounded-xl shadow p-6 flex flex-col justify-center">
          <h3 className="text-2xl font-bold text-pink-600 mb-4 text-center md:text-left">OBJECTIVE</h3>
          <p className="text-lg text-cyan-100 text-center md:text-left">
        ...
        {/* Right: Education */}
        <div className="flex-1 bg-gray-900 rounded-xl shadow p-6 flex flex-col justify-center">
          <h3 className="text-2xl font-bold text-pink-600 mb-4 text-center md:text-left">EDUCATION</h3>
